...
-- 2
SELECT
cidade.nome, estado.sigla, cidade.ativo
FROM
cidade, estado
WHERE
estado.id = cidade.estado_id AND cidade.ativo = 'S';

-- 3
SELECT
cliente.nome, cidade.nome 
FROM
cidade, cliente
WHERE
cidade.id = cliente.cidade_id;
...
cliente, cidade
WHERE
cidade.id = cliente.cidade_id AND cidade.nome LIKE "%PARANAVAI%";

-- 5.	Escreva o comando que liste os nomes das cidades e as respectivas siglas do estado. Liste somente as cidades ativas.
SELECT
cidade.nome, cidade.ativo, estado.sigla
FROM
cidade, estado
WHERE
estado.id = cidade.estado_id AND cidade.ativo = 'S';
...
-- 6.	Escreva o comando que liste os nomes dos funcionários e os nomes das respectivas cidades. 
SELECT
cidade.nome, funcionario.nome
FROM
cidade, funcionario
WHERE
cidade.id = funcionario.cidade_id;

-- 7.	Escreva o comando que liste os nomes dos funcionários e a sigla do respectivo estado. 
SELECT
funcionario.nome, estado.sigla
FROM
funcionario, cidade, estado
WHERE
funcionario.cidade_id = cidade.id AND cidade.estado_id = estado.id;

-- 8.	Escreva o comando que liste os nomes dos cliente e os nomes das respectivas cidades. Liste somente os clientes que moram na região sul.
SELECT
cliente.nome, estado.sigla
FROM
